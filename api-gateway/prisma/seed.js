...
const REGIONS = [
  ...
  },
  {
    ...
    boundsMinLat: -10.0,
    boundsMaxLat: 55.0,
    boundsMinLon: 55.0,  // Start east of Africa/Middle East boundary
    boundsMaxLon: 180.0,
  },
...
const MCP_SERVERS = [
  ...
  // Kenya
  {
    ...
    endpointUrl: 'https://gap-weather-mcp.up.railway.app',
    category: 'weather',
    isGlobal: false,
    isDeployed: true,
    ...
    longDescription: 'Get specialized weather forecasts designed for Kenyan farmers from TomorrowNow\'s Global Agricultural Platform (GAP). Access multiple forecast types: Salient seasonal forecasts for planning (up to 14 days), CBAM high-resolution daily forecasts (up to 10 days), and Nowcast precipitation alerts for immediate rain probability (next 12 hours). Make weather-informed decisions for planting, irrigation, and harvesting.',
    features: [
      { icon: 'calendar_month', title: 'Seasonal Forecast', description: 'Plan up to 14 days ahead with Salient ensemble forecasts for temperature and precipitation' },
      { icon: 'wb_sunny', title: 'Daily Detailed', description: 'CBAM high-resolution forecasts with evapotranspiration and solar radiation data' },
      { icon: 'water_drop', title: 'Nowcast Alerts', description: 'Know rain probability for the next 12 hours - perfect for spray timing' },
      { icon: 'satellite_alt', title: 'Satellite-Based', description: 'Forecasts powered by satellite data and AI models for Kenyan conditions' },
    ],
    useCases: [
      'Check if it will rain before spraying pesticides',
      'Plan irrigation based on upcoming rainfall',
      'Schedule outdoor farm activities around weather windows',
      'Get evapotranspiration data for water management',
    ],
    dataSource: 'TomorrowNow GAP / Salient / CBAM',
    supportedCrops: [],
    supportedRegions: ['Kenya'],
    heroColor: '#03A9F4',
    // Widget Configuration
    widgetCategory: 'weather',
    requiresInput: false,
  ...
  },
  {
    ...
    endpointUrl: 'https://tomorrow-now-decision-tree-mcp-server.up.railway.app',
    category: 'agriculture',
    isGlobal: false,
    isDeployed: false,
  ...
  // Vietnam/Global weather
  {
    ...
    endpointUrl: 'https://weatherapi-mcp.up.railway.app',
    category: 'weather',
    isGlobal: false,
    isDeployed: true,
    tools: ['get_weather_by_coords', 'get_forecast', 'get_weather_history', 'get_astronomy'],
    capabilities: ['weather', 'forecast', 'historical', 'astronomy'],
    icon: 'wb_sunny',
    color: '#FF5722',
    // Marketing content
    tagline: 'Weather data for global locations',
    longDescription: 'Access comprehensive weather data for any location worldwide through WeatherAPI. Get current conditions, multi-day forecasts, historical weather data, and astronomy information. Supports Vietnamese language for localized weather descriptions.',
    features: [
      { icon: 'thermostat', title: 'Current Conditions', description: 'Real-time temperature, humidity, wind, and precipitation data' },
      { icon: 'calendar_month', title: 'Forecasts', description: 'Multi-day weather predictions to plan farming activities' },
      { icon: 'history', title: 'Historical Data', description: 'Access past weather records for crop planning' },
      { icon: 'wb_twilight', title: 'Astronomy', description: 'Sunrise, sunset, moon phases for activity planning' },
    ],
    useCases: [
      'Check current weather before starting field work',
      'Plan activities around upcoming weather conditions',
      'Review historical patterns for crop selection',
      'Know sunrise/sunset times for work scheduling',
    ],
    dataSource: 'WeatherAPI.com',
    supportedCrops: [],
    supportedRegions: ['Vietnam', 'Global'],
    heroColor: '#FF5722',
    // Widget Configuration
    widgetCategory: 'weather',
    requiresInput: false,
    inputWidget: {
      ...
      reason: 'You can customize the forecast duration.',
    },
    outputWidget: {
      type: 'weather_forecast_card',
    },
