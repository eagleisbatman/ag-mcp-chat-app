...
export const en = {
  ...
  extensionWorker: {
    ...
    connectionInfo: 'The farmer will receive a connection request. Once approved, you can chat on their behalf and manage their farm data.',
  ...
  ration: {
    ...
    selectBreedPrompt: 'Reply with the number or name.',
