...
export default function VoiceRecorder({ 
  ...
  }, [isSpeaking, isRecording, audioLevel, wavePhase, waveAmplitude]);
  ...
  const handleMeteringUpdate = (metering: number): void => {
  ...
  }, [recordingDuration, isTranscribing, onTranscriptionComplete, onCancel, transcribeAudio, language, showError]);
